...
class BaseContact:
    ...
    def contact(self):
        return f"Wybieram {self.telefon} i dzwonię do {self.imie}"
...
class BusinessContact(BaseContact):
    ...
    def contact(self):
        return f"Wybieram {self.telefon1} i dzwonię do {self.imie}"
    
    def __repr__(self):
        return f'{self.imie}, {self.telefon}, {self.mail}, {self.stanowisko}, {self.firma}, {self.telefon1}'
